...
function (_React$Component) {
  ...
  function User() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePermissionChange", function (e) {
      ...
      var updatedPermissions = [_this.state.permissions]; // Figure out if we need to remove or add this permission

      if (checkbox.checked) {
        // Add it in 
        updatedPermissions.push(checkbox.value);
      } else {
        upadatedPermissions = updatedPermissions.filter();
      }

      _this.setState({
        permissions: updatedPermissions.filter()
      });
...
//# sourceMappingURL=permissions.js.a04cf5b12265910519d2.hot-update.js.map